		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
				...
				<div class="form-group">
				<label for="mod_identificacion" class="col-sm-3 control-label">Número de cédula</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_identificacion" name="mod_identificacion">
				</div>
			  </div>
			   <div class="form-group">
			  ...
			  <div class="form-group">
				<label for="mod_estado" class="col-sm-3 control-label">Estado cliente</label>
				<div class="col-sm-8">
