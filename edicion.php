<?php
  ...
  $title="Configuración | Webmarket";
  
  $query_empresa=mysqli_query($con,"SELECT * FROM empresa where id_perfil=1");
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 toppad" >
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title"><i class='glyphicon glyphicon-pencil'></i> Edición de datos de factura</h3>
            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <select class='form-control input-sm' name="moneda" required>
                            <?php 
                              $sql="SELECT name, symbol FROM  moneda GROUP BY symbol ORDER BY name ";
            ...
            <div class="panel-footer text-center">
              <button type="submit" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-refresh"></i> Actualizar datos</button>
            </div>
          </div>
        </div>
      </form>
